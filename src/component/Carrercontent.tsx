...
const Carrercontent: React.FC<Props>= ({name,content1,content2,content3})=> {

  return(
    <div className=''>
      <div className='flex justify-center'>
        <div className='mb-20  w-1/3 h-64  bg-blue-50   border-black border-solid border rounded-t-xl rounded-b-xl rescarrercontent'>
